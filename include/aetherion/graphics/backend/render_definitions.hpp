...
namespace aetherion {
    ...
    enum class RenderQueueType : FlagType {
        None = 0,
        Graphics = 1 << 0,
        Compute = 1 << 1,
        Transfer = 1 << 2,
    ...
    DECLARE_FLAG_ENUM(RenderQueueType)

    constexpr RenderQueueTypeFlags ALL_QUEUE_TYPES
        = RenderQueueType::Graphics | RenderQueueType::Compute | RenderQueueType::Transfer
          | RenderQueueType::Present;
