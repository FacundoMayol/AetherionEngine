...
namespace aetherion {
    ...
    struct AttachmentDescription {
        ...
        GPUImageLayout imageLayout;
        ResolveMode resolveMode = ResolveMode::None;
        IGPUImageView* resolveImageView;  // Optional, used if resolveMode is not None.
        GPUImageLayout resolveImageLayout = GPUImageLayout::Undefined;
    ...
    class ICommandBuffer {
      public:
        ...
        virtual void clear(IGPUImage& image, GPUImageLayout layout,
        ...
        virtual void copyBuffer(IGPUBuffer& src, IGPUBuffer& dst,
